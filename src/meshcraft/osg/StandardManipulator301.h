...
#ifndef OSGGA_CAMERA_MANIPULATOR2
#define OSGGA_CAMERA_MANIPULATOR2 1

#include <osgGA/CameraManipulator>


/** StandardManipulator2 class provides basic functionality
    for user controlled manipulation.*/
class StandardManipulator2 : public osgGA::CameraManipulator
{
    ...
    public:
        ...
        StandardManipulator2( int flags = DEFAULT_SETTINGS );
        StandardManipulator2( const StandardManipulator2& m,
        ...
        virtual const char* className() const { return "StandardManipulator2"; }
		...
		void setCurrentOperation(int c) { __currentOperation = c; }
...
inline bool StandardManipulator2::getRelativeFlag( int index ) const
{
    return ( _relativeFlags & (0x01 << index) ) != 0;
}

inline void StandardManipulator2::setRelativeFlag( int index, bool value )
{
...
inline bool StandardManipulator2::getVerticalAxisFixed() const
{
    return _verticalAxisFixed;
}

/// Returns true if the camera can be thrown, false otherwise. It defaults to true.
inline bool StandardManipulator2::getAllowThrow() const
{
    return _allowThrow;
}

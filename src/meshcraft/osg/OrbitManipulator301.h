...
#ifndef OSGGA_ORBIT_MANIPULATOR2
#define OSGGA_ORBIT_MANIPULATOR2 1
...
class OrbitManipulator2 : public StandardManipulator2
{
        typedef StandardManipulator2 inherited;

    public:

        OrbitManipulator2( int flags = DEFAULT_SETTINGS );
        OrbitManipulator2( const OrbitManipulator2& om,
                          const osg::CopyOp& copyOp = osg::CopyOp::SHALLOW_COPY );

        META_Object( osgGA, OrbitManipulator2 );
...
inline double OrbitManipulator2::getTrackballSize() const  { return _trackballSize; }
/** Get the mouse wheel zoom factor.*/
inline double OrbitManipulator2::getWheelZoomFactor() const  { return _wheelZoomFactor; }
